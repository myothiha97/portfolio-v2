...
export const SevenElevenContents = () => {
  return (
    <ContentLayout
      link="https://www.7-eleven.com.sg"
      title="7-Eleven Singapore"
      duration="Jan 2023 - Nov 2023"
      imgSrc="/projects/7-eleven.webp"
      description="7-Eleven Singapore is a website built for 7-eleven which was founded in 1927, is the world's largest convenience store chain. The name “7-Eleven,” introduced in 1946, reflected its extended hours (7:00 am to 11:00 pm). By the 1960s, it pioneered 24-hour operations. Today, it leads global convenience retail with over 67,000 stores in 21 countries.
Built with modern tools like Next.js, React, TypeScript, Tailwind CSS, React Query, and Recoil."
    />
  );
};

export const YogaMovementContents = () => {
  return (
    <ContentLayout
      link="https://www.yogamovement.com"
      title="Yoga Movement"
...
The application is built using modern technologies, including React, TypeScript, Sass, and Redux."
      imgSrc="/projects/yoga-movement-min.webp"
    />
  );
};

export const TrifectaContents = () => {
  return (
    <ContentLayout
      title="Trifecta Singapore"
      link="https://trifectasingapore.com"
...
It is built with cutting-edge technologies, including Next.js, React.js, TypeScript, Tailwind CSS, Recoil, and React Query."
      imgSrc="/projects/trifecta-min.webp"
    />
  );
};

export const EsExpressContents = () => {
  return (
    <ContentLayout
      link="https://express.extraspaceasia.com.sg"
      ...
      imgSrc="/projects/es-express-1-min.webp"
    />
  );
};

export const RezervContents = () => {
  return (
    <ContentLayout
      link="https://www.rezerv.co"
...
The platform is built using modern technologies, including Next.js, React.js, TypeScript, Tailwind CSS, Material-UI, Styled-Components, React Query, Redux and Recoil"
      imgSrc="/projects/rezerv-min.webp"
    />
  );
};

export const NeurogleeContents = () => {
  return (
    <ContentLayout
      link="https://www.neuroglee.com"
...
It is developed using modern technologies, including Next.js, React.js, TypeScript, Tailwind CSS, and Recoil."
      imgSrc="/projects/neuroglee-min.webp"
    />
  );
};

export const AIAMyanmarContents = () => {
  return (
    <ContentLayout
...
The portal was built by Typescript, Sass, React, React Query and Redux."
      imgSrc="/projects/kcuts-1-min.webp"
    />
  );
};
